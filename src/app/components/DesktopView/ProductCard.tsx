    ...
    return (
        <Card shadow="none" radius="none" className="w-[250px] h-[440px] bg-transparent">
            ...
            <Modal size="full" className="h-screen" isOpen={isOpen} onOpenChange={onOpenChange} hideCloseButton>
                <ModalContent className="flex items-center justify-center h-screen min-h-screen gap-2 bg-black/60">
                    <div className="flex flex-row w-full justify-between p-2 max-w-md items-center">
                        <h3 className="text-white font-semibold capitalize">
                            {product.name}
                        </h3>
                        <Button isIconOnly variant="light" color="primary" className="text-white mb-1" onClick={onOpenChange}>
